<%@ Page MaintainScrollPositionOnPostback="true" Language="C#" AutoEventWireup="true" CodeBehind="Relatorio_Henry.aspx.cs" Inherits="HavikTeste.Relatorio_Henry" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="grid_relatorio_henry" runat="server" 
            ...
            <Columns>
                <asp:BoundField DataField="id_projeto_havik" HeaderText="código" SortExpression="id_projeto_havik">
                ...
                <asp:BoundField DataField="motivos" HeaderText="motivos" SortExpression="motivos">
                                    <ItemStyle Wrap="False" />
                </asp:BoundField>
