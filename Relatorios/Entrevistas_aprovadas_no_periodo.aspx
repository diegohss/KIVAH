<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entrevistas_aprovadas_no_periodo.aspx.cs" Inherits="HavikTeste.Entrevistas_aprovadas_no_periodo" %>
...
<body>
    ...
    <div class="title" style="font-size: x-large; font-weight: bold;">
                ...
                ENTREVISTAS REALIZADAS E APROVADAS POR AGENDADOR NO PERÍODO - 
    &nbsp;<asp:Label ID="label_periodo" runat="server" Text=""></asp:Label>
    </div>   
    <div>
    
        <asp:GridView ID="grid_entrevistas_aprovadas_periodo" runat="server" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Entrevistador" HeaderText="agendador" SortExpression="Entrevistador">
                                    <ItemStyle Wrap="False" />
                </asp:BoundField>
