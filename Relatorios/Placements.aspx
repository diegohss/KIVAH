<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Placements.aspx.cs" Inherits="HavikTeste.Relatorios.Placements" %>
...
<body>
    ...
    <div>    
        <asp:GridView ID="grid_relatorio_placements" runat="server" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="id_projeto" HeaderText="id projeto" SortExpression="id_projeto">
                                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="projeto" HeaderText="projeto" SortExpression="projeto">
                                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="qtd_clientes" HeaderText="qtd_clientes" SortExpression="qtd_clientes">
                                    <ItemStyle Wrap="False" />
                </asp:BoundField>                  
            </Columns>
        </asp:GridView>
